...
pressure = float(input("Enter coefficient pressure: ")) 
 humidity = float(input("Enter coefficient 
humidity: ")) # Get time point 
...
temperature, pressure, humidity, time = set_of_inputs weather_parameter 
= temperature * time**2 + pressure * time + humidity 
